...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'anscturner';//this will be your WCC username
      $dbUsr = 'anscturner';//this will be your WCC username
      $dbPass = '11SaQ5Tp5qELC0b';//this will be the password found in the video.
